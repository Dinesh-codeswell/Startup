...
const Opportunities = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-r from-[#4ebbf8]/10 to-[#334EAC]/10 rounded-full blur-3xl" />
      <div className="absolute bottom-20 right-20 w-40 h-40 bg-gradient-to-r from-[#BAD6EB]/10 to-[#4ebbf8]/10 rounded-full blur-3xl" />
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 max-w-6xl mx-auto">
          {/* Left: Internships */}
          <Card
            className={`h-96 border-white/20 transition-all duration-500 relative rounded-2xl group overflow-hidden animate-shimmer cursor-pointer ${
          ...
          <div className="space-y-8">
            <Card
              className={`h-44 border-white/20 transition-all duration-500 relative rounded-2xl group overflow-hidden animate-shimmer cursor-pointer ${
                isVisible ? "animate-scale-in" : "opacity-0"
              }`}
              style={{
                animationDelay: "0.1s",
