...
// Sample participants for testing the hierarchical algorithm
...
/**
 * Test the hierarchical matching algorithm
 */
export function testHierarchicalAlgorithm() {
  ...
  const result = matchParticipantsToTeams(sampleParticipants);
