...
import { User, Mail, GraduationCap, Calendar, AlertCircle, CheckCircle, Users } from "lucide-react"
...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          <Card className="shadow-lg border-0 bg-white mb-6">
            <CardHeader className="pb-6">
              <CardTitle className="text-xl font-semibold text-gray-900">Team Dashboard</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600 mb-4">
                Access your team dashboard to collaborate with teammates and manage your projects.
              </p>
              <Button onClick={() => setShowTeamDashboard(true)} className="bg-teal-600 hover:bg-teal-700 text-white">
      ...
      {showTeamDashboard && <TeamDashboard onClose={() => setShowTeamDashboard(false)} />}
    </div>
  )
}
